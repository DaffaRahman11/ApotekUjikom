<x-layout-admin>
  ...
  >
  <h6 class="fw-semibold mb-0">Tambah Pelanggan Baru</h6>
  <ul class="d-flex align-items-center gap-2">
    ...
    <li>-</li>
    <li class="fw-medium">Tambah Pelanggan</li>
  </ul>
</div>
    ...
    <div class="row justify-content-center">
      <div class="col-xxl-6 col-xl-8 col-lg-10">
        <div class="card border">
          <div class="card-body">
            <form action="/dashboard/pelanggan" method="POST" data-toggle="validator">
              @csrf
              <div class="mb-20">
                <label
                  for="namaPelanggan"
