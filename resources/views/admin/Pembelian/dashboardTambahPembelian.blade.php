...
>
  <h6 class="fw-semibold mb-0">Transaksi Pembelian Baru</h6>
  <ul class="d-flex align-items-center gap-2">
    ...
    <li>-</li>
    <li class="fw-medium">Tambah Pembelian</li>
  </ul>
</div>
      ...
      <div class="col-lg-8">
        <div class="shadow-4 border radius-8">
          ...
          <div class="py-28 px-20">
            <form action="/dashboard/pembelian" method="POST">
              @csrf
            <div
            ...
            >
              ...
              <div>
                <h6 class="text-md">Transaksi Pembelian Obat</h6>
                <div class="mb-20">
                  <label
                    for="namaSuplier"
